...
namespace OnlineShopping.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            //Session is basically used for storing the value on server. It support any kind of object.
            //It is best state managment technique that stores data as client side.
